      ...
      <header className={`w-full h-auto group fixed duration-100 transition-all ${isScrolled ? 'top-0' : 'top-10'}`}>
        <div className="bg-rojo relative z-30">
          <div className="max-w-[90rem] w-full mx-auto p-4 flex gap-6 items-center">
            ...
            <TooltipUser />
            {/*"<Cart />"*/}
            <div className="lg:block hidden h-full justify-center items-center">
              <SheetCart />
            </div>

            <a href="#" className="items-center gap-2 text-white bg-verde px-6 py-2 my-auto rounded-lg h-fit lg:flex hidden">
        ...
        <div className={`w-full bg-rojo-claro relative ${isScrollingUp ? 'translate-y-0' : '-translate-y-60' } h-auto group-hover:translate-y-0 transition-all duration-500`}>
          <div className="max-w-[90rem] w-full mx-auto flex gap-4 py-9 p-5 justify-between items-end">
            ...
            <a href="/CATÁLOGO_POLONIA_2025.pdf" target="_blank" className="bg-black text-white rounded-xl py-2 px-6 h-fit hidden lg:flex gap-3">
